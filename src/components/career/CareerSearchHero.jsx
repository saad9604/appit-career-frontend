  ...
  return (
    <section className="relative w-full h-[200px] 2xs:h-[230px] xs:h-[260px] sm:h-[320px] md:h-[380px] lg:h-[400px] overflow-hidden mt-[70px] sm:mt-[80px] md:mt-[95px]">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto h-full flex flex-col justify-center items-center px-3 2xs:px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        {/* Subheading */}
        <p className="text-white text-center font-jost text-sm 2xs:text-base xs:text-lg sm:text-xl md:text-2xl lg:text-[27px] font-semibold leading-[120%] max-w-[280px] 2xs:max-w-[340px] xs:max-w-[420px] sm:max-w-[600px] md:max-w-[800px] transition-all duration-300 shadow-text">
...
export default CareerSearchHero;