...
const CareerApplyBreadcrumb = () => {
  return (
    <div className="flex w-full max-w-[1239px] h-[60px] px-2 sm:px-4 md:px-6 py-[5px] mx-auto sm:ml-2 md:ml-8 lg:ml-10 items-center gap-4 sm:gap-6 md:gap-[25px] border-b border-[#B0B0B0] bg-white">
      ...
      {/* Search Link with Arrow */}
      <Link href="/career-search" className="flex justify-center items-center gap-2 sm:gap-3 md:gap-[18px] group">
        <span className="text-[#5D5D5D] font-jost text-base sm:text-lg md:text-[21px] font-semibold leading-[120%] group-hover:text-[#EC1C26] transition-colors">
          Search
        </span>
        <div className="w-[24px] h-[24px] sm:w-[30px] sm:h-[30px] md:w-[40px] md:h-[40px] transform rotate-0 group-hover:translate-x-1 transition-transform">
      ...
      {/* Job Details Text (Current page - not clickable) */}
...
export default CareerApplyBreadcrumb;